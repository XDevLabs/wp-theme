...
function xdevlabs_scripts() {
	wp_enqueue_style( 'xdevlabs-base', get_stylesheet_uri(), array(), _S_VERSION );
	wp_enqueue_style( 'font-awesome-5', '//cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css', null, '5.15.1' );
	wp_enqueue_style( 'xdevlabs', get_template_directory_uri() . '/assets/css/styles.css', array(), wp_get_theme()->get( 'Version' ) );
    ...
    wp_enqueue_script( 'xdevlabs', get_template_directory_uri() . '/assets/js/xdevlabs.js', array('slick', 'jquery'), _S_VERSION, true );
